...
load('./processed_data/tr_reduction_ensembles/tr_kv_1000_ens_1000_deg_8','tr_un');
tr_1000 = tr_un;
tr_1000_names = fieldnames(tr_1000);

load('./processed_data/tr_reduction_ensembles/tr_kv_1000_ens_1000_deg_8','triangle_reduced_matrix');
mat_1000 = unique(triangle_reduced_matrix);

load('./processed_data/d1_d2_unstructured_reduction_data_structs','d2_reduc_unstructured');
...
load('./processed_data/d1_d2_generator_locs.mat','d2_gen_struct')

% NOTE: raw bus and generator data not available in the toy data
